...
export const OUTING_SYSTEM = `You are given where someone lives (a town or postcode), the current month, and a few of their closest friends with things they know about each.
Using web search, find THREE specific, real things to do within about 5 miles of their home in the coming month: a cafe, restaurant, bar, walk, market, gallery or exhibition, gig, comedy night, class, or a dated event. Prefer things with a date in the coming month, and things that connect to what a friend likes (a comedy fan → a comedy night; a runner → a parkrun; a new parent → something child-friendly).
